...
- (void)hasUpdateVersion{
    ...
    //蒲公英的apikey，appkey
    NSDictionary *paramDic = @{@"_api_key":@"d98734ffcbcb99a86ff217e63c46ecfe",@"appKey":@"8714cac1cdc14376b29a5bc966696392"};
...
//时间格式化函数
+(NSDateFormatter*) getContainingChineseFullDateFormatter{
    ...
    if(sharedDateFormatterInstance == nil){
        ...
        [sharedDateFormatterInstance setDateFormat:@"yyyy年MM月dd日HH时mm分"];
        [sharedDateFormatterInstance setLocale:[NSLocale currentLocale]];
    }
...
+(NSDateFormatter*) getFullDateFormatter{
    ...
    if(sharedDateFormatterInstance == nil){
        sharedDateFormatterInstance = [[NSDateFormatter alloc] init];
        [sharedDateFormatterInstance setDateFormat:@"yyyy-MM-dd HH:mm"];
        [sharedDateFormatterInstance setLocale:[NSLocale currentLocale]];
    }
    return sharedDateFormatterInstance;
}
